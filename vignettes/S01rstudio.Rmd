 ...
 * Tutoriels : https://www.rstudio.com/collections/rstudio-essentials/
 * Feuilles de triche : https://www.rstudio.com/resources/cheatsheets/
...
![Créez un projet au début de chaque cours !](img/S01rstudio/Projet.gif){width=80% loop=10}
...
### Créez un projet pour le lundi matin. Quel est votre répertoire de travail pour ce projet ?

## Exercice 2

### Allez dans le menu "Help" puis sélectionnez "About Rstudio". Quelle est votre version de Rstudio ? Renseignez-la dans [le document partagé](https://docs.google.com/document/d/1dOspKPfs2QDQwoNth7HMEfGKLAorkxImJ1J67rzV-vk/edit)
